...
public class MergedJobDriver {
    ...
    public static final String MULTIPLE_OUTPUTS_ANONYMIZE = "MULTIPLE_OUTPUTS_ANONYMIZE";
    public static final String MULTIPLE_OUTPUTS_DISTINCT = "MULTIPLE_OUTPUTS_DISTINCT";


    public static void main(String[] args) throws Exception {
        Job job = new Job(new Configuration(), "MergedJobDriver");
